        ...
        <div className="flex flex-wrap items-center gap-3 flex-1">
          ...
          {companies.length > 0 && (
            <select
              ...
              className="px-3 py-2 text-sm rounded-xl border border-slate-200 bg-slate-50 text-slate-700 focus:ring-2 focus:ring-blue-500 focus:border-transparent hover:bg-slate-100 transition-colors"
            >
