    ...
    <div className="bg-white rounded-2xl shadow-md p-4 sm:p-5">
      <div className="flex flex-col sm:flex-row sm:items-center gap-4">
        <div className="flex items-center gap-2">
          <svg className="w-5 h-5 text-cascadia-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="flex flex-wrap items-center gap-3 flex-1">
          ...
          {companies.length > 0 && (
            <select
              ...
              className="px-3 py-2 text-sm rounded-xl border border-slate-200 bg-slate-50 text-slate-700 focus:ring-2 focus:ring-cascadia-500 focus:border-transparent hover:bg-slate-100 transition-colors"
            >
